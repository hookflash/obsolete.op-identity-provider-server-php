...
--
-- Host: localhost    Database: hf_password1_db
-- ------------------------------------------------------
...
--
-- Current Database: `hf_password1_db`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `hf_password1_db` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `contact` (
  ...
  `ppfSecret` varchar(64) DEFAULT NULL,
  `profileSecret` varchar(100) DEFAULT NULL,
  `regenerate` bit(1) DEFAULT NULL,
  `privatePeer_contactId` int(11) DEFAULT NULL,
  PRIMARY KEY (`contactId`),
  KEY `FK38B72420EE642572` (`peer_contactId`),
  KEY `FK38B72420175A02B4` (`privatePeer_contactId`),
  CONSTRAINT `FK38B72420175A02B4` FOREIGN KEY (`privatePeer_contactId`) REFERENCES `privatepeer` (`contactId`),
...
CREATE TABLE `identity` (
  ...
  `contact` varchar(100) DEFAULT NULL,
  `contactFindSecret` varchar(40) DEFAULT NULL,
  `contactUserID` varchar(40) DEFAULT NULL,
  `identitySecretSalt` varchar(64) DEFAULT NULL,
  `ppfSalt` varchar(32) DEFAULT NULL,
  `ppfSecretEncripted` varchar(40) DEFAULT NULL,
  `profileLastUpdated` bigint(20) DEFAULT NULL,
  `reloginAccessKey` varchar(200) DEFAULT NULL,
  `uriEncrypted` varchar(100) DEFAULT NULL,
...
CREATE TABLE `provider` (
  ...
  `user` int(11) NOT NULL,
  `completeUri` varchar(150) NOT NULL,
...
-- Dump completed on 2013-10-17 23:56:45
