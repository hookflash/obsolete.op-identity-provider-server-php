...
--
-- Host: localhost    Database: hf_service_db
-- ------------------------------------------------------
...
--
-- Current Database: `hf_service_db`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `hf_service_db` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `lockbox_content` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `accountId` varchar(40) NOT NULL,
  `contentKey` varchar(80) DEFAULT NULL,
...
CREATE TABLE `provider` (
  ...
  `devtoolsDatabaseCleanUrl` varchar(150) DEFAULT NULL,
...
-- Dump completed on 2013-10-17 23:57:22
